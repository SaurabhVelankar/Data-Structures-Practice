...
int main()
{
    ...
    printf("We'll be learning Linked list this time!\n");
    printf("\n\n");
    ...
    do
    {
        ...
        switch(choice) //Entered choices are in Switch case
        {
            ...
            case 8:
                if(head == NULL) //Edge case if Linked list id empty
                {
                ...
                printf("\n\n");
                printf("Fun Fact: This was printed using recursion!!\n\n");
            break;
...
void PrintLinkedListReverse(struct Node* temp) // Print Linked List without reversing it
{
    if(temp == NULL)
        return;

    PrintLinkedListReverse(temp -> next);
    printf("%d ", temp -> data); // Print later than the call for reverse print, before for normal print
}
